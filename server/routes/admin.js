...
router.get('/faker/CompostItemFive', (req, res, next) => {
  for (i = 0; i < 5; i++) {
    ...
    if (i == 0) {
      item.image =
        'https://i.pinimg.com/originals/ae/c7/d6/aec7d6a5fd9701adbb513887416b8291.jpg';
      item.title = 'Pizza boxes';
      item.description =
        'The pizza box is a folding box made of cardboard in which hot pizzas are stored for takeaway.';
    } else if (i == 1) {
      item.image =
        'https://images.pexels.com/photos/45161/teabag-tea-label-drink-45161.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940';
      item.title = 'Tea Bags';
      item.description =
      ...
      item.image =
        'https://www.gingercasa.com/wp-content/uploads/2016/11/used-coffee-grounds.jpg';
      item.title = 'Coffee Grounds';
      item.description =
        'Coffee grounds are the waste product from brewing coffee.';
    } else if (i == 3) {
      item.image =
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQERfb2Nl5NwhzBrKDDrC39VfIMN67uMi8BJ9Ud0tm1WNv0N5cj';
      item.title = 'Paper Towel';
      item.description =
        'A Paper towel is an absorbent towel made from tissue paper instead of cloth.';
    } else if (i == 4) {
      item.image =
        'https://i.guim.co.uk/img/static/sys-images/Guardian/Pix/pictures/2014/12/25/1419535813760/2215166779_81043f2d7e_o-2060x1236.jpeg?w=300&q=55&auto=format&usm=12&fit=max&s=fe471b8a145a1c4a89d476ee1123eafd';
...
router.get('/faker/RecycleItemSix', (req, res, next) => {
  for (i = 0; i < 6; i++) {
    ...
    if (i == 0) {
      ...
      item.image =
        'https://st.depositphotos.com/1561359/5117/v/450/depositphotos_51177197-stock-illustration-pile-of-newspaper.jpg';
      item.title = 'Newspaper';
      item.description = 'A newspaper is a publication printed on paper.';
    } else if (i == 2) {
      item.image =
        'https://thumbs.dreamstime.com/b/red-crushed-soda-can-empty-smashed-pop-isolated-white-background-71920441.jpg';
      item.title = 'Metal (Aluminum)';
      item.description = 'Silvery metal object';
    } else if (i == 3) {
      item.image =
        'https://images.pexels.com/photos/623046/pexels-photo-623046.jpeg?auto=compress&cs=tinysrgb&h=350';
      item.title = 'Magazine';
      item.description = 'A magazine is a publication printed on paper.';
    } else if (i == 4) {
      item.image =
        'https://c7.alamy.com/comp/FTTTAH/carton-milk-packaging-box-on-white-background-blank-paper-pack-for-FTTTAH.jpg';
      item.title = 'Carton';
      item.description =
        'A carton is a box or container usually made of paperboard and sometimes of corrugated fiberboard';
    } else if (i == 5) {
      item.image =
        'https://images.pexels.com/photos/802221/pexels-photo-802221.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940';
